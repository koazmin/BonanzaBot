...
- **Admin command (အလွယ်ဆုံး)**: Admin ၏ **personal account နှင့် page ကြားစကားဝိုင်း** (order noti ရသည့်နေရာ၊ PSID ကို `ADMIN_PSID_*` env တွင်ထည့်ထားသူ) တွင် **`pausebot`** ဟုရိုက်လျှင် bot တစ်ခုလုံးရပ်မည်၊ **`resumebot`** ဟုရိုက်လျှင် ပြန်ဖွင့်မည်။ Customer များ ဘာမှမမြင်ရပါ။ Customer တစ်ဦးက ဤစကားလုံးများရိုက်လျှင် သူ့စကားဝိုင်းတစ်ခုတည်းသာ သက်ရောက်သည်။
- **စကားဝိုင်းတစ်ခုချင်း (human takeover)**: Page inbox မှ လူကိုယ်တိုင် reply ပြန်လိုက်ရုံဖြင့် အဲဒီ customer အတွက် bot **တိတ်တဆိတ်** ရပ်သွားမည် (chat ထဲ ဘာစာမှ မပေါ်ပါ)။
- **Admin escalation**: Bot က မဖြေနိုင်သောမေးခွန်း (ဈေးဆစ်ခြင်း၊ ငွေလွှဲအတည်ပြု၊ complaint၊ စာရင်းထဲမပါသောပစ္စည်း) ကြုံလျှင် customer ကို "Admin နဲ့ ပြောနိုင်အောင် စီစဉ်ပေးပါမယ်ခင်ဗျာ" ဟုပြောပြီး admin ထံ Messenger noti (page, customer အမည်, မေးခွန်း) ပို့ကာ ထိုစကားဝိုင်းအတွက် bot ရပ်ထားမည်။ Customer က "👨‍💼 Admin နဲ့ပြောမယ်" ခလုတ်နှိပ်လျှင်လည်း အလားတူ ဖြစ်မည်။
