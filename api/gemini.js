...
- Include the product link when referring to any product using https://shop.boox.com
...
`;
  ...
  try {
    ...
    res.status(200).json({ reply, updatedHistory: fullContents, model: "gemini-1.5-pro" });
